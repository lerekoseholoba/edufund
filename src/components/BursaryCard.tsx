...
export function BursaryCard({ bursary }: BursaryCardProps) {
  ...
  return (
    <li className="group relative flex flex-col rounded-xl border border-greige-300 bg-nude-50 p-5 shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-md">
      ...
      <Link
        ...
        onFocus={prefetch}
      >
        <h3 className="font-display text-lg font-semibold text-ink-800 transition-colors group-hover:text-brown-700">
          {bursary.title}
        </h3>
